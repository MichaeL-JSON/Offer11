...
const MyInput = React.forwardRef((props,ref) => {
    return (
        <div style={{marginTop: '28px'}}>
            <div style={{position: 'relative', width: 631}}>
                <input ref={ref} className={classes.input_with_icon} {...props}/>
                <svg className={classes.input_icon} width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
